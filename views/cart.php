...
foreach ($_SESSION["cart"] as $pdCart) {
    ...
    $html_cart .= '
        ...
        <td class="cart-price">'. number_format($price,0,',','.').' đ</td>

        <td>
            <form action="" class="cart-quantity flex" method="POST">
                <button type="submit" id="decrement" name="decrement">-</button>
                <input type="number" name="quantity" id="quantity" value="'.$quantity.'"min="1" max="10">
                <button type="submit" id="increment" name="increment">+</button>
            </form>
            ...
            <div class="bill">
                ...
                <div class="bill-container">
                    ...
                    <div class="flex transience">
                        <p>Tạm Tính</p>
                        <p class="total-price"><?php if(isset($price)){ echo number_format($total_price,0,',','.');}?> đ
                        </p>
                    </div>
