                        ...
                        <div class="form-checkout">
                            <div class="form-container">
                                ...
                                <div class="group-checkout">
                                    ...
                                    <select name="transport" class="form-control" id="ship"
                                        onchange="saveShippingMethod()">
                                ...
                                <div class="pay-method">
                                    ...
                                    <div class="methods">
                                        <div class="method-group">
                                            ...
                                            <label for="cod-method">Thanh toán khi nhận hàng (COD)</label>
                                        </div>
                                        <div class="method-group">
                                            <input type="radio" name="method" id="vnpay-method" value="2">
                                            <label for="vnpay-method">Thanh toán Online qua VNPay</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="cart-container-mobile">
                            ...
                            <!-- <?php foreach ($_SESSION["cart"] as $key => $cart) { ?> -->
                                ...
                                <div class="cart-item-mb">
                                    <img src="Uploads/28ffeb35667a46f1a2d3a525e604ccb0_optimized_original_image.jpg" alt=""
                                        class="img-item">
