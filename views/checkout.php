                        ...
                        <form class="form-checkout" action="">
                            <div class="form-container">
                                ...
                                <div class="group-checkout">
                                    ...
                                    <input type="text" placeholder="Nhập họ tên của bạn" value="<?php if (isset($fullname)) {
                                        echo $fullname;
                                    } ?>">
                                </div>
                                ...
                                <div class="group-checkout">
                                    ...
                                    <input type="text" placeholder="Nhập email của bạn" value="<?php if (isset($email)) {
                                        echo $email;
                                    } ?>">
                                </div>
                                ...
                                <div class="group-checkout">
                                    ...
                                    <input type="text" placeholder="Nhập số điện thoại" value="<?php if (isset($phone)) {
                                        echo $phone;
                                    } ?>">
                                </div>
                                ...
                                <div class="group-checkout">
                                    ...
                                    <input type="text" placeholder="Nhập Địa Chỉ Cụ Thể" value="<?php if (isset($detail)) {
                                        echo $detail;
                                    } ?>
                                    ">
                                </div>
                                ...
                                <div class="group-checkout">
                                    ...
                                    <textarea name="" id="" rows="5" placeholder="Nhập ghi chú của bạn"></textarea>
                                </div>
                                ...
                                <div class="pay-method">
                                    ...
                                    <div class="methods">
                                        <div class="method-group">
                                            <input type="radio" name="method" id="cod-method" value="cod">
                                            <label for="cod-method">Thanh toán khi nhận hàng (COD)</label>
                                        </div>
                                        <div class="method-group">
                                            <input type="radio" name="method" id="vnpay-method" value="vnpay">
