    ...
    <div class="container">
        <div class="social-icon">
            ...
            <div class="icon flex" style="gap: 16px;">
                ...
                <div>
                    <a href="https://www.facebook.com/TokyoLifeOnline"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <rect width="24" height="24" rx="12" fill="url(#paint0_linear_2942_313004)"></rect>
                            <path d="M15.8766 13.0415L16.3395 10.0252H13.4453V8.06787C13.4453 7.24268 13.8496 6.43831 15.1458 6.43831H16.4616V3.87028C16.4616 3.87028 15.2676 3.6665 14.126 3.6665C11.7425 3.6665 10.1846 5.11117 10.1846 7.7264V10.0252H7.53516V13.0415H10.1846V20.3332H13.4453V13.0415H15.8766Z" fill="white"></path>
                            <defs>
                                <linearGradient id="paint0_linear_2942_313004" x1="12" y1="0" x2="12" y2="23.9288" gradientUnits="userSpaceOnUse">
