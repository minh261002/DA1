                        ...
                        <button type="submit" class="icon_search">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="icon-wrapper" clip-path="url(#clip0_10988_132346)">
                                    <path id="Union" fill-rule="evenodd" clip-rule="evenodd" d="M0.832031 7.66536C0.832031 11.432 3.8987 14.4987 7.66536 14.4987C11.432 14.4987 14.4987 11.432 14.4987 7.66536C14.4987 3.8987 11.432 0.832031 7.66536 0.832031C3.8987 0.832031 0.832031 3.8987 0.832031 7.66536ZM1.83203 7.66536C1.83203 4.45203 4.44536 1.83203 7.66536 1.83203C10.8854 1.83203 13.4987 4.45203 13.4987 7.66536C13.4987 10.8787 10.8854 13.4987 7.66536 13.4987C4.44536 13.4987 1.83203 10.8787 1.83203 7.66536ZM14.312 15.019C14.412 15.119 14.5387 15.1657 14.6653 15.1657C14.792 15.1657 14.9187 15.119 15.0187 15.019C15.212 14.8257 15.212 14.5057 15.0187 14.3123L13.6853 12.979C13.492 12.7857 13.172 12.7857 12.9787 12.979C12.7853 13.1723 12.7853 13.4923 12.9787 13.6857L14.312 15.019Z" fill="white"></path>
                                </g>
                                <defs>
        ...
        <ul class="header__menu">
            <div class="container">
                <div class="menu flex">
                    ...
                    <li><a href=""> <img src="assets/img/icon-new.webp" width="24px">Hàng Mới Về</a></li>
                    <li><a href=""> <img src="assets/img/icon-new.webp" width="24px">Giảm Giá</a></li>
                    <li><a href="">Nữ</a></li>
                    <li><a href="">Nam</a></li>
            ...
            <div class="header-group">
                <div class="search-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.45477 9.58366C1.45477 14.292 5.28811 18.1253 9.99644 18.1253C14.7048 18.1253 18.5381 14.292 18.5381 9.58366C18.5381 4.87533 14.7048 1.04199 9.99644 1.04199C5.28811 1.04199 1.45477 4.87533 1.45477 9.58366ZM2.70477 9.58366C2.70477 5.56699 5.97144 2.29199 9.99644 2.29199C14.0214 2.29199 17.2881 5.56699 17.2881 9.58366C17.2881 13.6003 14.0214 16.8753 9.99644 16.8753C5.97144 16.8753 2.70477 13.6003 2.70477 9.58366ZM18.3047 18.7757C18.4297 18.9007 18.5881 18.959 18.7464 18.959C18.9047 18.959 19.0631 18.9007 19.1881 18.7757C19.4297 18.534 19.4297 18.134 19.1881 17.8923L17.5214 16.2257C17.2797 15.984 16.8797 15.984 16.6381 16.2257C16.3964 16.4673 16.3964 16.8674 16.6381 17.109L18.3047 18.7757Z" fill="#292D32"></path>
                    </svg>
                </div>
                ...
                <a href="#" class="bill-btn">
                    ...
                    <div class="icon-next">
                        <svg xmlns="http://www.w3.org/2000/svg" width="9" height="16" viewBox="0 0 9 16" fill="none">
                            <path d="M7.49844 15.2248C7.3401 15.2248 7.18177 15.1664 7.05677 15.0414L1.62344 9.60811C0.740104 8.72477 0.740104 7.27477 1.62344 6.39144L7.05677 0.958105C7.29844 0.716439 7.69844 0.716439 7.9401 0.958105C8.18177 1.19977 8.18177 1.59977 7.9401 1.84144L2.50677 7.27477C2.10677 7.67477 2.10677 8.32477 2.50677 8.72477L7.9401 14.1581C8.18177 14.3998 8.18177 14.7998 7.9401 15.0414C7.8151 15.1581 7.65677 15.2248 7.49844 15.2248Z" fill="#292D32"></path>
                        </svg>
                    </div>
                </a>
            </div>
        ...
        <div class="side__bar-bottom">
            <div class="cate-item">
                <div class="cate-item_left">
                    <img src="https://tokyolife.vn/_next/image?url=https%3A%2F%2Fpm2ec.s3.ap-southeast-1.amazonaws.com%2Fcms%2F16963486069795189_512.png&w=640&q=75" alt="" width="24ppx">
                    <p>HÀNG MỚI VỀ</p>
                </div>
