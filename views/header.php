...
<body>
    ...
    <header class="header__pc">
        ...
        <ul class="header__menu">
            <div class="container">
                <div class="menu flex">
                    <li><a href="index.php?page=option_product&act=new"> <img src="assets/img/icon-new.webp" width="30px">Hàng Mới Về</a></li>
                    <li><a href="index.php?page=option_product&act=hot"> <img src="assets/img/icon-new.webp" width="30px">Giảm Giá</a></li>
                    <?= createMenu() ?>
                </div>
            </div>
        </ul>
