...
if (isset($_SESSION["user"]) && count($_SESSION["user"]) > 0) {
    ...
    $html_account = '
            <div class="icon-user">
                <img src="uploads/' . $_SESSION['user']['avatar'] . '" width="30px" style="border-radius:50%">

                <ul class="sub-menu-user">
                    <li>Xin chào, <span class="text-danger">' . $username . '</span></li>
            ...
            <div class="container">
                ...
                <div class="header__icon flex">
                    ...
                    <div class="icon-tracking">
                        <a href="index.php?page=search_bill">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <header class="header__mobile">
        <div class="header-middle">
            ...
            <div class="logo-header">
                <a href="index.php">
                    <img src="uploads/logo_owenstore.svg" alt="" width="133px">
                </a>
            </div>
    ...
    <section class="side__bar">
        <div class="side__bar-top">
            ...
            if (isset($_SESSION['user'])) { ?>
                ...
                <div class="log_reg">
                    <a href="index.php?page=profile&act=info" class="logo_user">
                        <img src="uploads/<?php echo $_SESSION['user']['avatar'] ?>" width="80" height="80px" style="border-radius: 50%;">
                    </a>
                    <div class="right">
                        <a href="index.php?page=profile&act=info"><?php echo $_SESSION['user']['fullname'] ?></a>
                    </div>
            ...
            <?php } else { ?>
                <div class="log_reg">
                    <a href="index.php" class="logo_user">
            ...
            <div class="bar__top-bottom">
                <a href="index.php?page=search_bill" class="bill-btn">
