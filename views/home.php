...
<main>
    ...
    <section class="about_us">
        <div class="about-content">
            ...
            <div class="about-desc">
                <p>Owen Shop là cửa hàng bán lẻ đồ gia dụng, hóa mỹ phẩm, phụ kiện chính hãng các thương hiệu Nhật Bản:
                    ...
                    Pelican… Nước hoa Owen Shop sản xuất tại Pháp. Hóa phẩm lành tính Owen Shop sản xuất tại Nhật Bản.
                    Mỹ phẩm Owen Shop sản xuất tại Nhật Bản, Hàn Quốc. Sản phẩm Thời trang và Phụ kiện hiệu: Owen Shop,
                    OwenNow, OwenBasic, OwenSmart, OwenSecret. Sản phẩm tiêu dùng hiệu: OwenLife, OwenHome, OwenSword...
                    và nhiều thương hiệu khác sản xuất tại Việt Nam, Trung Quốc, Thái Lan…</p>
    ...
    <div class="overlay">
        ...
        <script>
            ...
            let overlay_ = document.querySelector('.overlay');
