                        ...
                        <div class="order-product">
                            ...
                            <div class="cart-container-mobile">
                                ...
                                <div class="cart-item-mb">
                                    <img src="Uploads/28ffeb35667a46f1a2d3a525e604ccb0_optimized_original_image.jpg" alt="" class="img-item">
                                    <div class="cart-item-content">
                                        <div class="title-box">
                                            <a class="title-item" href="">
                                                <!-- <?php echo $cart['name'] ?> -->
                                                Quan dui ao dai ao tay quan da bónh
                                            </a>
                                        </div>
                                ...
                                <div class="status-order">
                                    <div class="status-ship">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
                                            <path d="M19.15 8a2 2 0 0 0-1.72-1H15V5a1 1 0 0 0-1-1H4a2 2 0 0 0-2 2v10a2 2 0 0 0 1 1.73 3.49 3.49 0 0 0 7 .27h3.1a3.48 3.48 0 0 0 6.9 0 2 2 0 0 0 2-2v-3a1.07 1.07 0 0 0-.14-.52zM15 9h2.43l1.8 3H15zM6.5 19A1.5 1.5 0 1 1 8 17.5 1.5 1.5 0 0 1 6.5 19zm10 0a1.5 1.5 0 1 1 1.5-1.5 1.5 1.5 0 0 1-1.5 1.5z">
                                            </path>
                                        </svg>
                                        Đang giao
                                    </div>
                                    <div class="total-order">200đ</div>
                                </div>
                            </div>
                            <div class="cart-container-mobile">
                                <p class="id-order">#0189237</p>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <!-- <?= $html_cart ?> -->
                                    <tr class="cart-row">
                                        <td> <img src="./assets/img/4ac928b9e8c84c94b45c5a9c8f5dcad8_optimized_original_image.jpg" width=" 50px"> </td>
