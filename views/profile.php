            ...
            <div class="container-profile">
                <div class="profile_option">
                    ...
                    <div class="option-block flex">
                        ...
                        <a href="index.php?page=order">Đơn Hàng Của Tôi</a>
                    </div>
                ...
                <div class="profile-content">
                    ...
                    <div class="content-info">
                        <form class="upload-profile" action="index.php?page=update_user" enctype="multipart/form-data" method="POST">
                            <div class="avatar">
                            ...
                            <div class="info-user">
                                ...
                                <div class="form-group px-5 mb-4 ">
                                    ...
                                    <input type="email" id="email" class="form-control" disabled value="<?php if (isset($email)) {
                                                                                                            echo $email;
                                                                                                        } ?>">
                                ...
                                <div class="form-group px-5 mb-4">
                                    ...
                                    <input type="text" name="detail" id="detail" class="form-control" placeholder="Nhập Địa Chỉ Cụ Thể" value="<?php if (isset($detail)) {
                                                                                                                                                    echo $detail;
                                                                                                                                                } ?>">
                                </div>
                                <div class="form-group px-5 mb-4">
                                    <button type="submit" name="btn_update_user" class="btn-form"> Lưu Thay Đổi</button>
                                </div>
                            </div>
                        </form>
                    </div>
