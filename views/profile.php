...
if (isset($address)) {
    ...
    if ($addressData !== null) {
        ...
        if (isset($addressData["ward"])) {
            $ward = $addressData["ward"];
        }

        if (isset($addressData["detail"])) {
