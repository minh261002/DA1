    ...
    <section class="search py-5">
        <div class="wrap-content">
            <div class="search-head">
                ...
                <span style="font-weight: bold;"><?php echo $_GET['key'] ?></span>
                <span>
                    <?php
                    $key = $_GET['key'];
                    $products = search($key);
                ...
                ?>
                            ...
                            <div class="product-item">
                                ...
                                <div class="product-content">
                                    <a href="index.php?page=details&id=<?php echo $pro['id'] ?>" class="name-product"><?php echo $pro['name'] ?></a>
                                    <div class="product-price">
                                        <span class="product-origin"><?php echo number_format($pro['price'] - ($pro['sale'] * $pro['price'] / 100), 0, ',', '.') ?>đ</span>
                                        <span class="product-discount"><?php echo number_format($pro['price'], 0, ',', '.') ?>đ</span>
                                    </div>
                                </div>
                                ...
                                <div class="product-status">
                                    ...
                                    <span class="percent-discount"><?php echo $pro['sale'] ?>%</span>
                                </div>
                            </div>
                <?php
                        }
